...
layout: page
title: "Key Findings"
description: "Six analytical findings from 1,200+ FOIA records — each translating a structural feature of the public record into the fiduciary terms Arkansas law already establishes."
permalink: /findings/
...
Each finding is sourced from the underlying FOIA productions documented on our [evidence](/evidence/) and [documents](/documents/) pages; the analysis below translates that record into the public-facing fiduciary argument.

<div class="findings-grid" markdown="1">

<article class="finding-card" markdown="1">

## [The Broker-Dealer Regulatory Record](/findings/regulatory-record/)
...
## [The Cross-Agency Control Case](/findings/control-case/)
...
## [The Auditor's Office as Pension Investment Channel](/findings/auditor-channel/)
...
## [The SFOF Pipeline](/findings/sfof-pipeline/)
...
## [The Post-Vote Oversight Gap](/findings/oversight-gap/)
...
## [The Procedural Asymmetry](/findings/procedural-asymmetry/)
