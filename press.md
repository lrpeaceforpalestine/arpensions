---
layout: landing
title: "Press Kit — Media Resources for Arkansas Pension Investigation"
...
<ul class="timeline">
  <li class="timeline-event">
    ...
    <strong>Arkansas first purchases non-tradable sovereign bonds</strong>
    <p>State Treasury purchases through outreach from the bond issuer's sales representatives to then-Treasurer Dennis Milligan.</p>
  </li>
</ul>
...
<ul class="timeline">
  ...
  <li class="timeline-event timeline-event--highlight">
    ...
    <p>S&amp;P downgrades the issuing country&rsquo;s sovereign credit rating, with negative outlook.</p>
  </li>
  <li class="timeline-event timeline-event--highlight">
    <time datetime="2024-08">August 2024</time>
    <strong>Fitch downgrade: A+ &rarr; A</strong>
    <p>Third major agency downgrades the issuing country, with negative outlook.</p>
  </li>
  <li class="timeline-event timeline-event--highlight">
    <time datetime="2024-09">September 2024</time>
    <strong>Moody&rsquo;s second downgrade: A2 &rarr; Baa1</strong>
    <p>Moody&rsquo;s further downgrades the issuing country, with negative outlook.</p>
  </li>
  <li class="timeline-event timeline-event--highlight">
    <time datetime="2024-10">October 2024</time>
    <strong>S&amp;P second downgrade: A+ &rarr; A</strong>
    <p>S&amp;P further downgrades the issuing country, with negative outlook.</p>
  </li>
  <li class="timeline-event timeline-event--highlight">
  ...
  <li class="timeline-event">
    ...
    <strong>Auditor arranges bond issuer meetings</strong>
    <p>State Auditor Milligan arranges for the bond issuer's representatives to meet with state officials.</p>
  </li>
</ul>
...
<ul class="timeline">
  <li class="timeline-event timeline-event--highlight">
    ...
    <p>Auditor Milligan and executive assistant Wendy Spadoni send four meeting arrangement emails within 18 minutes, scheduling the bond issuer's sales executives with the heads of APERS, ATRS, and the Treasury &mdash; all in Room 230 of the Auditor&rsquo;s Capitol office, all CC&rsquo;d to deputy Jason Brady.</p>
  </li>
  <li class="timeline-event timeline-event--highlight">
    <time datetime="2025-04-14">April 14–15, 2025</time>
    <strong>Bond issuer's representatives meet state officials</strong>
  ...
  <li class="timeline-event">
    ...
    <p>APERS receives first bond statement, confirming a purchase eventually occurred.</p>
  </li>
  <li class="timeline-event timeline-event--highlight">
    <time datetime="2025-12">December 2025</time>
    <strong>ATRS deploys full $50M</strong>
    <p>ATRS Deputy Director Rod Graves confirms in a board liquidity update that the full $50 million sovereign bond mandate was funded through the Scout (Reams) account &mdash; without independent credit analysis at any stage.</p>
  </li>
</ul>
...
<ul class="timeline">
  ...
  <li class="timeline-event">
    ...
    <p>ATRS: 7 documents. Auditor of State: 124 documents from three custodians (Milligan, Brady, Spadoni) via General Counsel TJ Fowler. Round 2 corpus: 1,222 documents.</p>
  </li>
</ul>
...
<span class="pull-quote-attribution">— Lawrence Berman, the bond issuer's national managing director, replying to the Auditor's office on the October 7 anniversary ([source document](/assets/documents/milligan-oct7-anniversary-berman-reply-2024.pdf))</span>
...
<span class="pull-quote-attribution">— Jason Brady, Auditor of State's appointee to APERS board, introducing the investment to the board (June 11, 2025)</span>
...
**No independent credit analysis has been produced.** A review of more than 1,200 public records from Arkansas state agencies found zero independent credit analyses.
...
**The bond market offers many alternatives with higher credit ratings and greater liquidity.** These bonds cannot be traded before maturity and carry declining credit ratings.

**The Auditor's appointee served as conduit.** Jason Brady introduced the investment to the APERS board citing Treasury holdings, not independent analysis. The board approved $25–50 million.

**The board voted before staff were ready.** APERS authorized $25–50 million but purchased nothing for two months. The CIO was still establishing contact with the bond issuer in late July 2025.
...
Arkansas is part of a broader national pattern. As of early 2026, at least nine state- and local-level campaigns — including Arkansas — scrutinize sovereign bond investments by public entities:

- **Minnesota** — State Board of Investment sold over $13 million in these bonds; holdings dropped from $11.8M to $470K by October 2025.
- **Michigan** — State treasury declined to reinvest a $10 million bond that matured in November 2025. FOIA requests revealed that the bond issuer's national managing director repeatedly emailed the Michigan treasury pleading for reinvestment and offering rates higher than publicly available.
- **Pennsylvania** — [Spotlight PA investigation](https://www.spotlightpa.org/news/2026/03/stacy-garrity-treasurer-governor-election-israel-bonds-ethics-elections/) documented Treasurer Stacy Garrity's $45 million in purchases since October 7 and her attendance at an industry gala — paralleling the political-financial blurring documented in Arkansas.
- **Palm Beach County, FL** — Holds approximately $1 billion in these bonds (15–18% of portfolio). Two lawsuits filed over concentration risk; Florida passed a law exempting these bonds from minimum bond rating requirements.
- **New York** — Former NYC Comptroller let ~$39M in sovereign bonds lapse. New York State's Common Retirement Fund held $352 million as of March 2024.
...
- **North Carolina** — State pension fund sold $6.7 million in foreign government bonds in October 2025.
