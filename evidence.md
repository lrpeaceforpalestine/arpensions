...
<span class="pull-quote-attribution">— ATRS Executive Director Mark White, after the June 2, 2025 vote</span>
...
<ul class="bar-chart" role="list" aria-label="Non-tradable sovereign bond authorized or committed exposure by agency">
  ...
  <li>
    <div class="bar-chart-label"><span>APERS (Public Employees)</span><span>$25–50M</span></div>
...
<ol class="timeline" role="list" aria-label="2026 events">
  ...
  <li class="timeline-event" data-aos="fade-left">
    <time>June 2026</time>
    <h3>AJRS produces no records by the deadline</h3>
    <p>The May 15, 2026 AJRS production deadline passed with no records produced; as of early June 2026 the Round 4 request remains outstanding. AJRS commingles its investments with APERS under Act 1242 — the same structure under which ASPRS confirmed no responsive records — so a null result would be consistent with the cross-system pattern. The other five Act 498 pension systems have responded.</p>
  </li>
</ol>
</div>
...
<div class="legal-reference" markdown="1">
